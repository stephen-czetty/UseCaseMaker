...
namespace UseCaseMakerLibrary.Tests.UseCaseTests
{
    ...
    public class When_inserting_a_step_before_alternative_step : UseCaseTestBase
    {
        ...
        private It Should_set_previous_step_prefix_to_b = () => _previousStep.Prefix.ShouldEqual("B");
